...
<div class="card">
	<div class="card-header">
		<div class="row">
			<div class="col-md-9">
				<h3 class="panel-title">List of exams you created</h3>
			</div>
			<div class="col-md-3" align="right">
				<button type="button" id="add_button" class="btn btn-danger">Create Exam</button>
			</div>
		</div>
	</div>	
	<div class="card-body">
    	...
    	<form method="post" id="exam_form">
      		<div class="modal-content">
        		...
        		<div class="modal-body">
          			...
          			<div class="form-group">
              			<label>Exam Date & Time <span class="text-danger">*</span></label>
	                	<input type="text" name="online_exam_datetime" id="online_exam_datetime" class="form-control" readonly/>
          			</div>
          			<div class="form-group">
              			<label>Exam Duration <span class="text-danger">*</span></label>
          			...
          			<div class="form-group">
              			<label>Marks for Right Answer <span class="text-danger">*</span></label>
          			...
          			<div class="form-group">
              			<label>Marks for Wrong Answer <span class="text-danger">*</span></label>
	        	...
	        	<div class="modal-footer">
	        		...
	        		<input type="submit" name="button_action" id="button_action" class="btn btn-success" value="Create" />
...
<div class="modal" id="deleteModal">
  	<div class="modal-dialog">
    	<div class="modal-content">
      		...
      		<!-- Modal footer -->
      		<div class="modal-footer">
      			<button type="button" name="ok_button" id="ok_button" class="btn btn-primary btn">OK</button>
      		...
      		<div class="modal-content">
        		...
        		<div class="modal-body">
        			<div class="form-row">
        				<div class="col">
        					<div class="form-group">
	        					<label for="question_title">Question Title <span class="text-danger">*</span></label>
        			...
        			<div class="form-row">
        				<div class="col">
        					<div class="form-group">
	        					<label for="option_title_1">Option 1 <span class="text-danger">*</span></label>
		                		<input type="text" name="option_title_1" id="option_title_1" autocomplete="off" class="form-control" />
        					</div>
        				</div>
        				<div class="col">
        					<div class="form-group">
        						<label for="option_title_2">Option 2 <span class="text-danger">*</span></label>
        			...
        			<div class="form-row">
        				<div class="col">
        					<div class="form-group">
	        					<label for="option_title_3">Option 3 <span class="text-danger">*</span></label>
		                		<input type="text" name="option_title_3" id="option_title_3" autocomplete="off" class="form-control" />
        					</div>
        				</div>
        				<div class="col">
        					<div class="form-group">
        						<label for="option_title_4">Option 4 <span class="text-danger">*</span></label>
        			...
        			<div class="form-row">
        				<div class="col-sm-12 col-md-6">
        					<div class="form-group">
        						<label for="answer_option">Right Answer <span class="text-danger">*</span></label>
	        	...
	        	<div class="modal-footer">
	        		...
	        		<input type="hidden" name="page" value="view_questions" />

	        		<input type="hidden" name="action" id="hidden_action" value="Add" />

	        		<input type="submit" name="question_button_action" id="question_button_action" class="btn btn-success" value="Add" />
...
$(document).ready(function(){
	...
	function reset_form()
	{
		$('#modal_title').text('Enter Exam Details');
		...
		if($('#question_form').parsley().validate())
		{
			$.ajax({
				...
				beforeSend:function(){
					...
					$('#question_button_action').val('Creating...');
				},
				success:function(data)
				{
					if(data.success)
