    	...
    	<form method="post" id="question_form">
      		<div class="modal-content">
	        	...
	        	<div class="modal-footer">
	        		...
	        		<input type="submit" name="question_button_action" id="question_button_action" class="btn btn-success" value="Edit" />
...
$(document).ready(function(){
	...
	var dataTable = $('#question_data_table').DataTable({
		...
		"ajax" :{
			url:"../ajax_action.php",
			method:"POST",
			data:{action:'fetch', page:'view_questions', code:code}
		},
		"columnDefs":[
			{
				"targets" :[2],
	...
	$(document).on('click', '.edit', function(){
		...
		$.ajax({
			url:"../ajax_action.php",
			method:"POST",
			data:{action:'edit_fetch', question_id:question_id, page:'view_questions'},
			dataType:"json",
			success:function(data)
			{
	...
	$('#ok_button').click(function(){
		$.ajax({
			url:"../ajax_action.php",
			method:"POST",
			data:{question_id:question_id, action:'delete', page:'view_questions'},
			dataType:"json",
			success:function(data)
			{
				$('#message_operation').html('<div class="alert alert-success">'+data.success+'</div>');
