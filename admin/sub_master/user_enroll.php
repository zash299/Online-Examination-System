...
<nav aria-label="breadcrumb">
  	<ol class="breadcrumb">
    	...
    	<li class="breadcrumb-item active" aria-current="page">Student Enrollment List</li>
  	</ol>
</nav>
<div class="card">
	<div class="card-header">
		<div class="row">
			<div class="col-md-9">
				<h3 class="panel-title">Student Enrollment List</h3>
			</div>
...
$(document).ready(function(){
	...
	var dataTable = $('#enroll_table').DataTable({
		...
		"ajax" : {
			url:"../ajax_action.php",
			type:"POST",
			data:{action:'fetch', page:'user_enroll', code:code},
		},
		"columnDefs" : [
			{
				"targets" : [0],
